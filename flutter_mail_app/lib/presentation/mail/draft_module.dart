...
import '../../external/mail/mail_memory/mail_memory_draft_data_source.dart';
...
class DraftModule extends Module {
  ...
  final List<Bind> binds = [
    Bind.lazySingleton<MailMemoryDraftDataSource>((_) => MailMemoryDraftDataSource()),
    Bind.lazySingleton<IMailRepository>(
      (i) => MailRepository(
        mailDataSource: i<MailMemoryDraftDataSource>(),
      ),
    ),
