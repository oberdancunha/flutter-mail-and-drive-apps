...
/// @nodoc
class _$DriveFailureTearOff {
  const _$DriveFailureTearOff();
...
/// @nodoc
const $DriveFailure = _$DriveFailureTearOff();
...
mixin _$DriveFailure {
  ...
  @JsonKey(ignore: true)
  $DriveFailureCopyWith<DriveFailure> get copyWith =>
      throw _privateConstructorUsedError;
}
...
abstract class $DriveFailureCopyWith<$Res> {
  factory $DriveFailureCopyWith(
          DriveFailure value, $Res Function(DriveFailure) then) =
      _$DriveFailureCopyWithImpl<$Res>;
  $Res call({String error});
}

/// @nodoc
class _$DriveFailureCopyWithImpl<$Res> implements $DriveFailureCopyWith<$Res> {
  _$DriveFailureCopyWithImpl(this._value, this._then);

  final DriveFailure _value;
  // ignore: unused_field
  final $Res Function(DriveFailure) _then;
...
/// @nodoc
class __$UnexpectedCopyWithImpl<$Res> extends _$DriveFailureCopyWithImpl<$Res>
...
class _$_Unexpected implements _Unexpected {
  ...
  @override
  String toString() {
    return 'DriveFailure.unexpected(error: $error)';
  }
...
abstract class _Unexpected implements DriveFailure {
